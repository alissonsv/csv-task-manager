...
>Esse desafio foi proposto pela [Rocketseat](https://www.rocketseat.com.br/), abaixo segue os detalhes passados por eles no desafio:
...
[Criação via CSV com Stream](./csv_import.md)
